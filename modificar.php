...
<div class="container">
    <form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="Titulo" name="Titulo" placeholder="Titulo" value="<?php echo $row['titulo']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="Autor" name="Autor" placeholder="Autor" value="<?php echo $row['autor']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="Editorial" name="Editorial" placeholder="Editorial" value="<?php echo $row['editorial']; ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="ISBN_10" class="col-sm-2 control-label">ISBN 10</label>
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="ISBN_10" name="ISBN_10" placeholder="ISBN 10" value="<?php echo $row['ISBN10']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="ISBN_13" name="ISBN_13" placeholder="ISBN 13" value="<?php echo $row['ISBN13']; ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="Fecha" class="col-sm-2 control-label">Año</label>
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="Fecha" name="Fecha" placeholder="Fecha" value="<?php echo $row['año']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="Paginas" name="Paginas" placeholder="Paginas" value="<?php echo $row['paginas']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="Idioma" name="Idioma" placeholder="Idioma" value="<?php echo $row['idioma']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="Clasificacion" name="Clasificacion" placeholder="Clasificacion" value="<?php echo $row['clasificacion']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input disabled="" type="text" class="form-control" id="aprobacion" name="Aprobacion" placeholder="Aprobacion" value="<?php echo $row['aprobacion']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <a href="solicitudes.php" class="btn btn-default">Regresar</a>
